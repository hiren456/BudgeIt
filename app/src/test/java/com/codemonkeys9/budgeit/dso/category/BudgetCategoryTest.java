...
public class BudgetCategoryTest {
    ...
    public void getNameTest(){
        ...
        int id = 42;
        Category cat = BudgetCategoryFactory.createBudgetCategory(name,goal,id);
    ...
    public void equalsTest(){
        ...
        Category cat2 = BudgetCategoryFactory.createBudgetCategory(name,goal,id);
    ...
    public void notEqualsTest(){
        ...
        int id = 42;
        Category cat1 = BudgetCategoryFactory.createBudgetCategory(name,goal,id);
        Category cat2 = BudgetCategoryFactory.createBudgetCategory(name,goal,id-1);
