...
public class IncomeTimelineTest {
    ...
    public void incomeTimelineTest() {
        ...
        ViewInteraction appCompatTextView = onView(
                allOf(withId(R.id.title), withText("Hide expenses"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.content),
                                        0),
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.amount), withText("1000.00"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textView.check(matches(withText("1000.00")));
        // TODO: check green
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.amount), withText("1000.00"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textView2.check(matches(withText("1000.00")));
        // TODO: check green
        ...
        ViewInteraction textView3 = onView(
                allOf(withId(R.id.amount), withText("1000.00"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textView3.check(matches(withText("1000.00")));
        // TODO: check green
    }
